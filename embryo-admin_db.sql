...
-- Generation Time: Jul 02, 2014 at 06:33 PM
...
(13, 'Σεούλ: Έμβρυα από ανθρώπινο δέρμα', '', 'Χρησιμοποιώντας ως πρώτη ύλη κύτταρα από το δέρμα δύο ενήλικων ανθρώπων, διεθνής ομάδα ερευνητών δημιούργησε έμβρυα από τα οποία απομονώθηκαν στη συνέχεια πολύτιμα βλαστοκύτταρα  -ένα επίτευγμα που φέρνει ένα βήμα πιο κοντά την παραγωγή ιστών και οργάνων κατά παραγγελία, ίσως όμως και τη γέννηση ανθρώπινων κλώνων.\r\n\r\nΟι αμερικανοί και νοτιοκορεάτες ερευνητές τροποποίησαν την τεχνική της μεταφοράς πυρήνα, η οποία χρησιμοποιήθηκε το 1996 για την κλωνοποίηση του προβάτου Ντόλι και βελτιώθηκε μόλις πέρυσι στο Πανεπιστήμιο Υγείας και Επιστημών του Όρεγκον.\r\n\r\nΣτη νέα μελέτη, οι ερευνητές αφαίρεσαν τον πυρήνα με το γενετικό υλικό από 77 ωάρια και τον αντικατέστησαν με τον πυρήνα κυττάρων που είχαν ληφθεί από το δέρμα δύο ανδρών, 35 και 75 ετών. Οι περισσότερες απόπειρες απέτυχαν, δύο όμως από τα ωάρια εξελίχθηκαν σε έμβρυα, από τα οποία απομονώθηκαν πολύτιμα βλαστοκύτταρα.\r\n\r\nΤα εμβρυακά βλαστοκύτταρα μπορούν δυνητικά να χρησιμοποιηθούν για την αντιμετώπιση μιας πληθώρας ασθενειών, ακόμα και για την καλλιέργεια οργάνων στο εργαστήριο.\r\n\r\nΜέχρι σήμερα, η μέθοδος που χρησιμοποιήθηκε στη μελέτη είχε εφαρμοστεί μόνο σε κύτταρα εμβρύων, και όχι σε κύτταρα από ενήλικες όπως τώρα.\r\n\r\nΗ έρευνα δημοσιεύεται στην επιθεώρηση Cell Stem Cell.\r\n\r\nΗ μέθοδος της μεταφοράς πυρήνα (ή πυρηνικής μεταφοράς) που χρησιμοποιήθηκε στην τελευταία μελέτη είναι μία από τις τρεις γνωστές μεθόδους παραγωγής εμβρυακών βλαστοκυττάρων. Μια άλλη λύση είναι η χρήση εμβρύων που έχουν περισσέψει από κλινικές εξωσωματικής γονιμοποίησης, τεχνική η οποία έχει αποδειχθεί αμφιλεγόμενη. Η τρίτη μέθοδος, η πλέον υποσχόμενη μέχρι σήμερα, ήταν η μετατροπή απλών κυττάρων σε βλαστοκύτταρα με την εισαγωγή τριών επιπλέον γονιδίων, τεχνική που βραβεύτηκε με Νόμπελ το 2012. \r\n\r\nΠρόσφατα, μάλιστα, αμερικανοί και ιάπωνες ερευνητές ανακοίνωσαν ότι δημιούργησαν εμβρυακά βλαστοκύτταρα απευθείας από σωματικά κύτταρα χωρίς να απαιτούνται επιπλέον γονίδια. Μέχρι στιγμής όμως το πείραμα δεν έχει αναπαραχθεί από άλλες ομάδες και η μελέτη δέχεται επικρίσεις.\r\n\r\nΗ τελευταία μελέτη αφορά τη λεγόμενη θεραπευτική κλωνοποίηση, δηλαδή την κλωνοποίηση με στόχο τη λήψη εμβρυακών βλαστοκυττάρων συμβατών με οποιονδήποτε συγκεκριμένο ασθενή. Δεδομένου όμως ότι οι ερευνητές δημιούργησαν δυνητικά βιώσιμα έμβρυα, η μελέτη τους δείχνει ότι η μέθοδος της μεταφοράς πυρήνα μπορεί δυνητικά να εφαρμοστεί και για τη γέννηση κλωνοποιημένων ανθρώπων -κάτι που απαγορεύεται ρητά στις περισσότερες χώρες.\r\n\r\nΠηγή: <a href="http://www.in.gr" target="blank">in.gr</a> (21.4.2014)', 'seoul_embrya.jpg', 2, 1, 1, '2014-06-27 17:56:38', '2014-06-27 17:56:38'),
(14, 'Η.Π.Α.: Εμφύτευση μήτρας σε γυναίκες με σύνδρομο MRKH', '', 'Οι επιστήμονες του Πανεπιστημίου Wake Forest στην Βόρεια Καρολίνα σχεδίασαν και εμφύτευσαν μήτρες σε τέσσερις γυναίκες που γεννήθηκαν με σύνδρομο Mayer-Rokitansky-Kunster-Hauser. Στις γυναίκες αυτές, το εν λόγω όργανο εξέλειπε ή δεν ήταν ορθά αναπτυγμένο κατά την γέννησή τους.\r\n\r\nΟι μελετητές σάρωσαν την πυελική περιοχή του κάθε ασθενή και κατασκεύασαν εξατομικευμένα καλούπια, τα οποία τα ενίσχυσαν με μυϊκά και κολπικά κύτταρα. Έπειτα, ανέπτυξαν τα προσαρμοσμένα όργανα σε έναν βιοαντιδραστήρα μέχρι τη στιγμή της εμφύτευσης στις ασθενείς. Η διαδικασία στέφθηκε με επιτυχία. Και οι τέσσερις γυναίκες ανέφεραν ότι απέκτησαν φυσιολογική σεξουαλική λειτουργία, ενώ οι επιστήμονες δεν αποκλείουν ακόμα και το ενδεχόμενο εγκυμοσύνης για τις δύο εκ των ασθενών, στις οποίες η κολπική σύνδεση στην μήτρα δεν επηρεάζεται από την αναπτυξιακή ασθένεια.\r\n\r\nΕν γένει, η επιστημονική κοινότητα παρουσιάζεται αισιόδοξη. Ωστόσο, ορισμένοι ερευνητές δείχνουν συγκρατημένοι και επισημαίνουν ότι το μονοπάτι για την ασφαλή χρησιμοποίηση τέτοιου τύπου εμφυτευμάτων αναμένεται μεγάλο και δύσβατο.\r\n\r\nΠηγή: <a href="http://www.the-scientist.com/?articles.view/articleNo/39696/title/Women-Receive-Lab-Grown-Vaginas/" target="blank">The Scientist</a> (6.5.2014)\r\n', 'usa_mitra.jpg', 2, 1, 1, '2014-06-27 18:02:19', '2014-06-27 18:02:19'),
(15, 'ΕΔΔΑ: Καταδίκη της Γαλλίας για υπόθεση παρένθετης μητρότητας', '', 'Το Ευρωπαϊκό Δικαστήριο Ανθρωπίνων Δικαιωμάτων καταδίκασε τη Γαλλία για την άρνησή της να αναγνωρίσει την πατρότητα παιδιών που γεννήθηκαν από παρένθετη μητέρα στο εξωτερικό, επιφυλασσόμενο παράλληλα να αποφανθεί επί της επιλογής των γαλλικών αρχών να απαγορεύουν την παρένθετη κύηση.\r\n\r\nΣτην πολυαναμενόμενη από τους υποστηρικτές της παρένθετης κύησης καταδικαστική απόφαση, το Δικαστήριο έκρινε ότι η άρνηση των αρχών να μεταγράψουν πράξεις αναγνώρισης πατρότητας που έγιναν στις ΗΠΑ, μετά τις γεννήσεις παιδιών από παρένθετες μητέρες, πλήττει την ταυτότητα των παιδιών. \r\nΤο Δικαστήριο έκρινε επίσης ότι "η πλήρης απαγόρευση δημιουργίας γονικής σχέσης ανάμεσα σε έναν πατέρα και τα βιολογικά παιδιά του αντιβαίνει" στην Ευρωπαϊκή Σύμβαση για τα Ανθρώπινα Δικαιώματα.\r\nΣτο Δικαστήριο είχαν προσφύγει δύο ζευγάρια γονέων, που δίνουν μάχες εδώ και χρόνια στα δικαστήρια για να μετεγγραφούν στο ληξιαρχείο της Γαλλίας τα πιστοποιητικά γέννησης των παιδιών τους που γεννήθηκαν από παρένθετες μητέρες στις ΗΠΑ. Και στις δύο περιπτώσεις, η σύλληψη των εμβρύων έγινε με τα σπερματοζωάρια του συζύγου και τα ωάρια δότριας. \r\n\r\nΤα δύο ζευγάρια προσέκρουσαν στις 6 του Απριλίου του 2011, σε μια απόρριψη του Ακυρωτικού Δικαστηρίου. Η ανώτατη δικαστική αρχή είχε κρίνει "αντίθετη προς τη δημόσια τάξη (...) την ξένη απόφαση (της αναγνώρισης της πατρότητας από παρένθετη κύηση), η οποία περιέχει διατάξεις που προσκρούουν στις βασικές αρχές του γαλλικού δικαίου". \r\n\r\nΜετά την αποτυχία αυτή, οι δύο οικογένειες προσέφυγαν στην ευρωπαϊκή δικαιοσύνη, επικαλούμενες διακρίσεις, παραβίαση της ιδιωτικής τους ζωής και του δικαιώματός τους να δημιουργήσουν οικογένεια. \r\n\r\nΤο Δικαστήριο έκρινε ότι η άρνηση των γαλλικών αρχών δεν τους είχε εμποδίσει να διάγουν οικογενειακό βίο "σε συνθήκες σε μεγάλο βαθμό παρόμοιες" με εκείνες των άλλων οικογενειών στη Γαλλία.\r\n\r\nΩστόσο, σύμφωνα με τους ευρωπαίους εισαγγελείς, τα παιδιά των δύο ζευγαριών βρίσκονταν "σε μια κατάσταση νομικής αβεβαιότητας", έστω κι αν στις δύο περιπτώσεις, οι γαλλικές αρχές κατέληγαν να αρνούνται να αναγνωρίσουν τη σχέση μεταξύ των παιδιών και του βιολογικού τους πατέρα.\r\n\r\nΠηγή: Newsite, 26.6.2014', 'edda_france.jpg', 2, 1, 1, '2014-06-27 18:05:58', '2014-06-27 18:05:58');
...
(13, 4, 'Αντώνης Τσαλίδης', 'a-tsalidis@hotmail.com', 'atsalidis.jpg'),
...
(2, 'stdespo', 'a09ba730bfc0a8567a182eb4e534c99425326670', 'stdespotopoulos@gmail.com', 1, '2014-05-04 19:00:00', '2014-05-04 19:00:00'),
...
(16, 'Μαρία Μηλαπίδου', '0acc34e83de372ce593b50f179f68633ea1dfed0', 'mimmaki@gmail.com', 2, '2014-06-24 23:44:08', '2014-06-24 23:44:08'),
(17, 'kalliopi.kipouridou', 'edbe6d22ff420d3eb7691fcf5e02fe1be16318f4', 'kalliopi.kipouridou@gmail.com', 4, '2014-06-26 13:01:02', '2014-06-26 13:01:02'),
(18, 'larry482', 'd795cd2cfd9a9a67982f23ec692785295d879bfc', 'larry482gr@yahoo.com', 4, '2014-06-26 20:56:43', '2014-06-26 20:56:43'),
(19, 'ΣΑΧΙΝΙΔΟΥ ΧΡΙΣΤΙΝΑ', 'f9695bba396466f9447ccf807bf9ff953d4abdb7', 'sachinidouchristina@hotmail.com', 2, '2014-06-28 14:37:45', '2014-06-28 14:37:45');
...
(15, 'Χρύσα', 'Καραγιάννη', 'νομικός', '25ης Μαρτίου 16', '6944530403', 1, 0, NULL),
(16, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL),
(17, 'ΚΑΛΛΙΟΠΗ', 'ΚΗΠΟΥΡΙΔΟΥ', 'ΔΙΚΗΓΟΡΟΣ', 'ΚΟΜΝΗΝΩΝ 22', '2310 276119', 1, 0, NULL),
(18, 'Λάζαρος', 'Καζαντζής', 'Web Developer', 'Νικομηδείας 19', '6945274744', 1, 0, NULL),
(19, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL);
