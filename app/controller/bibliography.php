<?php
class ControllerBibliography extends Controller {
	public function index($args = false) {
		if($args) {
			...
			$this->data['bibliography'] = $this->language->getLanguage('bibliography');
			$this->data['underConstruction'] = $this->language->getLanguage('underConstruction');
			
			// For use in under construction page.
			$this->data['pageTitle'] = $this->data['bibliography']['pageTitle'];
