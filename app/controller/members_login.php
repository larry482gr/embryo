<?php
class ControllerMembersLogin extends Controller {
	public function index($args = false) {
		if($args) {
			...
			$this->data['membersLogin'] = $this->language->getLanguage('membersLogin');
			$this->data['underConstruction'] = $this->language->getLanguage('underConstruction');
			
			// For use in under construction page.
			$this->data['pageTitle'] = $this->data['membersLogin']['pageTitle'];
