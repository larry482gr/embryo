<?php echo $dashboard; ?>
	  <div class="col-md-10">
	    <h3 class="page-title">Menu Tabs</h3>
		  ...
		  <table id="tabs-table" class="table table-hover col-md-9">
		  ...
		  <button id="add-new" class="col-md-2 btn btn-primary">Add New Tab</button>
		  <form id="create-new-tab" class="form-horizontal col-md-12" role="form" action="menu_tabs/create" method="post">
	      <?php
	        if(false) {
	      ?>
	      <div class="form-group">
