<?php
	...
	$language['home']['publishedOn'] = 'Published on';
	...
	$language['confAppl']['onlyNumeric'] = 'Fields "'.$language['confAppl']['phoneCountryCode'].'", "'.$language['confAppl']['phoneCityCode'].'", "'.$language['confAppl']['phoneNumber'].'", "'.$language['confAppl']['fax'].'" should contain only digits.';
	...
	$language['showSurveyLang']['possibleAnswers'] = 'Possible Answers: ';
