<?php
class ControllerStudies extends Controller {
	public function index($args = false) {
		...
		if($lang_id == 2)
			return $this->getCategory(12);
		else if($lang_id == 1)
			return $this->getCategory(24);
	...
	public function getCategory($catId) {
		...
		$lang_id = $this->language->getCurrentLanguageId();
		$this->data['lang'] = $this->language->getCurrentLanguage();
		$this->data['studies'] = $this->language->getLanguage('studies');
		$this->data['information'] = $this->language->getLanguage('information');
		
		$this->data['infoPage'] = 'studies';
				
		// For use in under construction page.
		$this->data['pageTitle'] = $this->data['studies']['pageTitle'];
